...
const VideoPlayer = () => {
    ...
    useEffect(() => {
        ...
        setIsLoading(true);
        axios
          .get(`https://www.googleapis.com/youtube/v3/videos?part=snippet%2C%20statistics&id=${videoId}&key=AIzaSyBECTQ9-UglEFWRsemrTyGIsqHUoAqmd8c`)
          .then(response => {
    ...
    async function createVideoInfo (video) {
        ...
        const response = await axios
                              .get(`https://www.googleapis.com/youtube/v3/channels?part=snippet%2C%20statistics&id=${channelId}&key=AIzaSyBECTQ9-UglEFWRsemrTyGIsqHUoAqmd8c`)
